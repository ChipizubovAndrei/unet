...
int main()
{
    ...
    float* output_blok_4;
    float* output_image;
    const char* path2image = "/home/galahad/Documents/5_course/1_semester/SRW/data/in_256.png";
    const char* path2save = "/home/galahad/Documents/5_course/1_semester/SRW/unet_v_01/mask_256_1.png";
    ...
    LeakyReLU(output, height, width, 64, 0.3);
    ...
    LeakyReLU(output_blok_1, height, width, 64, 0.3);
    ...
    LeakyReLU(output, height, width, 128, 0.3);
    ...
    LeakyReLU(output_blok_2, height, width, 128, 0.3);
    ...
    LeakyReLU(output, height, width, 256, 0.3);
    ...
    LeakyReLU(output_blok_3, height, width, 256, 0.3);
    ...
    LeakyReLU(output, height, width, 512, 0.3);
    ...
    LeakyReLU(output_blok_4, height, width, 512, 0.3);
    ...
    LeakyReLU(output, height, width, 1024, 0.3);
